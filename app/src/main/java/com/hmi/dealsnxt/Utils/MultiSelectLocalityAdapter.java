...
public class MultiSelectLocalityAdapter extends RecyclerView.Adapter<MultiSelectLocalityAdapter.MyViewHolder> {
    ...
    public MultiSelectLocalityAdapter(Context context, ArrayList<CityModel> userList, ArrayList<CityModel> selectedList, Activity activity1) {
