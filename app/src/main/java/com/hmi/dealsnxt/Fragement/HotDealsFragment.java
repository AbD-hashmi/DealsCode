...
//                                    dealsModel.setNumofOffers(outlet.optInt("dealCount"));
                                ...
                                if (compaing_array != null && compaing_array.length() > 0) {
                                    for (int k = 0; k < compaing_array.length(); k++) {
                                        ...
                                        try {
                                            ...
                                            dealsModel.setCta_video_url("http://www.sample-videos.com/video/mp4/720/big_buck_bunny_720p_1mb.mp4");
                                            dealsModel.setCta_url("https://android-developers.googleblog.com/");
                                            if (i % infoArray.length() == 0) {
                                                dealsModel.setCta_type("1");
                                            } else if (i % infoArray.length() == 1) {
                                                dealsModel.setCta_type("2");
                                            } else if (i % infoArray.length() == 1) {
                                                dealsModel.setCta_type("3");
                                            }
                                            if (i % 2 == 1) {
                                                arrayList.add(dealsModel);
                                            }
                    ...
                    adapter = new HotDealsAdaptor(arrayList, getActivity(), getActivity());
