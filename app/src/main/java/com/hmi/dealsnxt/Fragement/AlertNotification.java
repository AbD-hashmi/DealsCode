...
import com.hmi.dealsnxt.Adaptor.AlertAdapter;
...
public class AlertNotification extends Fragment {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    AlertAdapter adapter = new AlertAdapter(arrayList, getActivity(), getActivity(),AlertNotification.this);
