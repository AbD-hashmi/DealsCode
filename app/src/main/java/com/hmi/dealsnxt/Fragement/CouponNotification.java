...
import com.hmi.dealsnxt.Adaptor.CouponAdapter;
...
public class CouponNotification extends Fragment {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, url, new Response.Listener<String>() {
            ...
            public void onResponse(String response) {
                try {
                    ...
                    CouponAdapter adapter = new CouponAdapter(arrayList, getActivity(), getActivity(),CouponNotification.this);
