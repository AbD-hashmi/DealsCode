...
import com.hmi.dealsnxt.Fragement.AlertNotification;
...
public class AlertAdapter extends RecyclerView.Adapter<AlertAdapter.SimpleItemViewHolder> {
...
// Provide access to all the views for a data item in a view holder
    ...
    public AlertAdapter(List<OrderModel> items, Activity _activity, Context context, AlertNotification alertNotification) {
        this.items = items;
                                        ...
                                        public void onResponse(String response) {
                                            try {
                                                ...
                                                if (Integer.parseInt(Status) == 1) {
                                                    alertNotification.loadDetailist("");
