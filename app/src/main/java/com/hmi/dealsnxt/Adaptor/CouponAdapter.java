...
import com.hmi.dealsnxt.Fragement.CouponNotification;
...
public class CouponAdapter extends RecyclerView.Adapter<CouponAdapter.SimpleItemViewHolder> {
...
// Provide access to all the views for a data item in a view holder
    ...
    public CouponAdapter(List<OrderModel> items, Activity _activity, Context context, CouponNotification couponNotification) {
        this.items = items;
                                        ...
                                        public void onResponse(String response) {
                                            try {
                                                ...
                                                if (Integer.parseInt(Status) == 1) {
                                                    couponNotification.loadDetailist("");
